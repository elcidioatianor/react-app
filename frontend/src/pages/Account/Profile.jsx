                        ...
                        <Card.Body className='text-center p-4'>
                            <div className='mb-4'>
                                {profileData.avatarUrl && !imgError ? (
                                    ...
                                    <div
                                        className='rounded-circle bg-light text-dubaning-orange d-flex justify-content-center align-items-center mx-auto shadow-sm'
                                        style={{
                                            width: '120px',
                                            height: '120px',
                                            fontSize: '40px',
                            ...
                            <ListGroup
                                variant='flush'
                                className='text-start mb-4 border-top'
                            >
                            ...
                            {!editMode ? (
                                <Button
                                    variant='warning'
                                    className='w-100 py-2 rounded-pill bg-dubaning-orange border-0 text-white fw-bold'
                                ...
                                <div className='d-grid gap-2'>
                                    <Button
                                        variant='success'
                                        className='py-2 rounded-pill border-0 fw-bold'
                                                ...
                                                >
                                                    <Card.Body>
                                                        <Row className='align-items-center'>
                                                            ...
                                                            <Col
                                                                md={3}
                                                                className='text-center my-2 my-md-0'
                                                            >
                                                                {getStatusBadge(
                                                                    order.status
                                                                )}
            ...
            <Modal show={editMode} onHide={() => setEditMode(false)} centered>
                ...
                <Modal.Body className='px-4 pb-4'>
                    ...
                    <div className='d-grid gap-2 mt-4'>
                        <Button
                            variant='primary'
                            className='py-2 bg-dubaning-orange border-0 fw-bold'
                            onClick={handleSaveProfile}
                            disabled={saving}
                        >
                            {saving ? (
