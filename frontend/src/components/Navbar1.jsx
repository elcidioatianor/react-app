    ...
    <nav className="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
		...
		{user ? (
         <div className="navbar-nav ms-auto dropdown">
			  <Link to="#" className="d-block link-body-emphasis text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
				{user.avatarUrl && !imgError ? (
              <img
                src={user.avatarUrl}
                alt="Avatar"
        ...
        <div className="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="/accounts">Switch account</NavLink>
            </li>
          </ul>
        </div>
