    ...
    useEffect(() => {
        const fetchResults = async () => {
            ...
            try {
                ...
                if (filters.city) {
                    filtered = filtered.filter(p => p.store?.city === filters.city);
                }
            ...
            <div className="row g-4">
                    ...
                    <div className="card border-0 shadow-sm p-4 sticky-top" style={{ top: '100px' }}>
                        ...
                        <div className="mb-4">
                            ...
                            <select className="form-select" value={filters.city} onChange={e => setFilters({ ...filters, city: e.target.value })}>
                                <option value="">Moçambique Inteiro</option>
                        ...
                        <button className="btn btn-outline-primary w-100" onClick={() => setFilters({ category: "", city: "", minPrice: "", maxPrice: "" })}>
                            Limpar Filtros
                        </button>
                    </div>
                </div>
                ...
                <div className="col-lg-9">
                    <h4 className="fw-bold mb-4">
                        {loading ? 'Pesquisando...' : `${products?.length || 0} resultados para "${query}"`}
                    </h4>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-5 bg-light rounded-3">
                            ...
                            <p className="text-muted">Tente usar outros termos ou limpe os filtros.</p>
                        </div>
                    ) : (
                                    ...
                                    <Link to={`/product/${product.id}`} className="text-decoration-none text-dark">
                                        <div className="card h-100 border-0 shadow-sm product-card">
                                            ...
                                            <div className="card-body">
                                                <small className="text-primary fw-bold">{product.category}</small>
                                                ...
                                                <div className="mt-2 d-flex align-items-center small text-muted">
                                                    <i className="bi bi-geo-alt me-1"></i> {product.store?.city || 'Maputo'}
                                                </div>
                                            </div>
                                        </div>
                                    </Link>
