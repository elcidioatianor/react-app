...
export function Learn() {
    return (
        <div className="container">
            ...
            /*** * We can render the button any times, each button will * have
            its own state. If we want all instances to share the same state, *
            then we should move our state to the parent component e.g Learn, *
            and pass the state (from parent component) as a prop (to each
            button) * */
            <MyButton />
        </div>
    );
...
function MyApp() {
    ...
    return (
        <div>
            ...
            <MyButton1 count={count} onClick={handleClick} /> //declared as
            props in the Button1 component
