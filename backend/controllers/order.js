...
exports.createOrder = async (req, res) => {
    try {
        const { items, total, paymentMethod, deliveryMethod, customerName, customerPhone, customerAddress } = req.body;
...
exports.getMyOrders = async (req, res) => {
    try {
        const orders = await Order.findAll({
            ...
            include: [{ model: OrderItem, as: 'items' }, { model: Store, as: 'store' }],
